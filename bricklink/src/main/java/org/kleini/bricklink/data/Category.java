...
public enum Category {
    ...
    FENCE(13, "Fence"),
    MAGNET(14, "Magnet"),
    MINIFIGURE_HEADGEAR(16, "Minifigure, Headgear"),
    MINIFIGURE_UTENSIL(18, "Minifigure, Utensil"),
    MINIFIGURE_WEAPON(19, "Minifigure, Weapon"),
    MINIFIGURE_BODY_PART(20, "Minifigure, Body Part"),
    CONE(21, "Cone"),
    HINGE(22, "Hinge"),
    LEVER(24, "Lever"),
    PLANT(25, "Plant"),
    ...
    LADDER_AND_BRIDGE(90, "Ladder & Bridge"),
    PANEL(91, "Panel"),
    ...
    MINIFIGURE_BODY_WEAR(142, "Minifigure, Body Wear"),
    OTHER(143, "(Other)"),
    ...
    MINIFIGURE_TORSO(150, "Minifigure, Torso"),
    ZNAP(152, "Znap"),
    ...
    MINIFIGURE_HEAD(238, "Minifigure, Head"),
    PEN(241, "Pen"),
    ...
    CARD_GAME_CARD(333, "Card, Game Card"),
    ...
    YEAR_2002(378, "2002"),
    ROOF(379, "Roof"),
    CARD_TRADING_CARD(380, "Card, Trading Card"),
    BUILDING_SET_WITH_PEOPLE(388, "Building Set with People"),
    HOLIDAY_AND_EVENT(390, "Holiday & Event"),
    ...
    MINIFIGURE_SHIELD(418, "Minifigure, Shield"),
    ...
    CARD_POSTCARD(472, "Card, Postcard"),
    SPORTS(473, "Sports"),
    BULK_BRICKS(478, "Bulk Bricks"),
    COCKPIT(479, "Cockpit"),
    DISCOVERY(482, "Discovery"),
    TECHNIC_FLEX_CABLE(483, "Technic, Flex Cable"),
    MINIFIGURE_LEGS_ASSEMBLY(484, "Minifigure, Legs Assembly"),
    MINIFIGURE_TORSO_ASSEMBLY(485, "Minifigure, Torso Assembly"),
    ...
    CARD_COLLECTOR_CARD(564, "Card, Collector Card"),
    YEAR_2006(565, "2006"),
    FACTORY(566, "Factory"),
    ...
    MINIFIGURE_HEAD_MODIFIED(606, "Minifigure, Head, Modified"),
    ...
    MINIFIGURE_HEADGEAR_ACCESSORY(636, "Minifigure, Headgear Accessory"),
    ...
    LEGO_IDEAS_CUUSOO(817, "LEGO Ideas (CUUSOO)"),
    FUSION(822, "Fusion"),
    YEAR_2015(826, "2015"),
    ...
    MINIFIGURE_HAIR(847, "Minifigure, Hair"),
    ...
    BOOST(921, "BOOST"),
    POWERPUFF_GIRLS(925, "Powerpuff Girls"),
    ...
    MINIFIGURE_UTENSIL_DECORATED(943, "Minifigure, Utensil, Decorated"),
    THE_INCREDIBLES(957, "The Incredibles"),
    SPECIAL_ASSEMBLY(961, "Special Assembly"),
    UNIKITTY(965, "Unikitty!"),
    BRICK_ARCH_DECORATED(966, "Brick, Arch, Decorated"),
    THE_LEGO_MOVIE_2(971, "The LEGO Movie 2"),
    CONE_DECORATED(974, "Cone, Decorated"),
    OVERWATCH(975, "Overwatch"),
    LEGO_BRAND(976, "LEGO Brand"),
    BALL(978, "Ball"),
    PROMOTIONAL(983, "Promotional"),
    RING(989, "Ring"),
    ACCESSORY_HUMAN_TOOL(990, "Accessory, Human Tool"),
    CHAIN(991, "Chain"),
    PROJECTILE_LAUNCHER(992, "Projectile Launcher"),
    SPRING(993, "Spring"),
    ENERGY_EFFECT(994, "Energy Effect"),
    PARTY_SUPPLIES(995, "Party Supplies"),
    CARD_GREETING_CARD(996, "Card, Greeting Card"),
    CARD(997, "Card"),
    PLAYMAT(998, "Playmat"),
    SLIDE(999, "Slide"),
    FORMS_AND_SURVEYS(1003, "Forms & Surveys"),
    GUIDE_BOOK(1004, "Guide Book"),
    SMOKING_SUPPLIES(1005, "Smoking Supplies"),
    ENVELOPE_AND_STAMP(1006, "Envelope & Stamp"),
    ACCESSORY_PACK(1007, "Accessory Pack"),
    DECORATION(1008, "Decoration"),
    AIRCRAFT_DECORATED(1012, "Aircraft, Decorated"),
    STICKER_COLLECTIBLE_STICKER(1017, "Sticker, Collectible Sticker"),
    CERTIFICATE(1018, "Certificate"),
    MAGAZINE_CITY(1021, "Magazine, City"),
    MAGAZINE_FRIENDS(1022, "Magazine, Friends"),
    MAGAZINE_NEXO_KNIGHTS(1023, "Magazine, Nexo Knights"),
    MAGAZINE_NINJAGO(1024, "Magazine, Ninjago"),
    MAGAZINE_STAR_WARS(1025, "Magazine, Star Wars"),
    MAGAZINE_LEGENDS_OF_CHIMA(1026, "Magazine, Legends of Chima"),
    WHEEL_ACCESSORY(1027, "Wheel, Accessory"),
    YEAR_2019(1028, "2019"),
    TRADING_CARD_ALBUM(1030, "Trading Card Album"),
    DUPLO_PLANT(1037, "Duplo, Plant"),
    DUPLO_FOOD_AND_DRINK(1038, "Duplo, Food & Drink"),
    TILE_PROMOTIONAL(1039, "Tile, Promotional"),
    MIX(1040, "Mix"),
    FORMA(1041, "FORMA"),
    HIDDEN_SIDE(1042, "Hidden Side"),
    STRANGER_THINGS(1043, "Stranger Things"),
    XTRA(1044, "xtra"),
    ROAD_SIGN_DECORATED(1048, "Road Sign, Decorated"),
    AFOL_DESIGNER_PROGRAM(1056, "AFOL Designer Program"),
    CLIKITS_ICON_ACCENT(1059, "Clikits, Icon Accent"),
    CARDBOARD_SLEEVE(1060, "Cardboard Sleeve"),
    MAGAZINE_SUPER_HEROES(1063, "Magazine, Super Heroes"),
    TOY_WOODEN(1064, "Toy, Wooden"),
    LEGO_ORIGINALS(1065, "LEGO Originals"),
    YEAR_2020(1066, "2020"),
    TROLLS_WORLD_TOUR(1069, "Trolls World Tour"),
    MINIONS_THE_RISE_OF_GRU(1070, "Minions The Rise Of Gru"),
    DOTS(1076, "Dots"),
    FELT(1078, "Felt"),
    MICRO_DOLL_BODY_PART(1082, "Micro Doll, Body Part"),
    MAGAZINE_HIDDEN_SIDE(1083, "Magazine, Hidden Side"),
    MAGAZINE_JURASSIC_WORLD(1084, "Magazine, Jurassic World"),
    MAGAZINE_ELVES(1085, "Magazine, Elves"),
    MAGAZINE_BIONICLE(1086, "Magazine, Bionicle"),
    MAGAZINE_DISNEY_PRINCESS(1087, "Magazine, Disney Princess"),
    MAGAZINE_THE_LEGO_MOVIE_2(1088, "Magazine, The LEGO Movie 2"),
    PLATE_ROUND_DECORATED(1090, "Plate, Round, Decorated"),
    STORAGE_SORTING_TRAY(1092, "Storage, Sorting Tray"),
    WEDGE_PLATE_DECORATED(1093, "Wedge, Plate, Decorated"),
    SUPER_MARIO(1095, "Super Mario"),
    MINIFIGURE_TORSO_ASSEMBLY_DECOR(1097, "Minifigure, Torso Assembly, Decor."),
    MINIFIGURE_LEGS_DECORATED(1098, "Minifigure, Legs, Decorated"),
    MONKIE_KID(1100, "Monkie Kid"),
    FAIRGROUND_COLLECTION(1101, "Fairground Collection"),
    STICKER_BOOK(1102, "Sticker Book"),
    BRICK_SKETCHES(1103, "Brick Sketches"),
    PAPER_FLYER(1104, "Paper, Flyer"),
    EXPLORER(1108, "Explorer"),
    MAGAZINE_EXPLORER(1109, "Magazine, Explorer"),
    MISCELLANEOUS_LICENSED(1110, "Miscellaneous Licensed"),
    CLOTHING_ACCESSORIES(1111, "Clothing Accessories"),
    LUGGAGE_AND_LUGGAGE_ACCESSORIES(1112, "Luggage & Luggage Accessories"),
    OFFICE_SUPPLIES(1113, "Office Supplies"),
    MINIFIGURE_LEGS_MODIFIED(1116, "Minifigure, Legs, Modified"),
    MINIFIGURE_LEGS_MODIFIED_DECORATED(1118, "Minifigure, Legs, Modified, Decorated"),
    YEAR_2021(1119, "2021"),
    DUPLO_BUILDING(1121, "Duplo, Building"),
    BOTANICAL_COLLECTION(1122, "Botanical Collection");
