...
function listHeader ( page, ps )
{
	...
	page. color = new Color ( "#fff" );
	page. drawText ( ps. x                   , y, xs( ps. w, 15 ), h, page.AlignCenter, "Image" );
	page. drawText ( ps. x + xs( ps. w,  15 ), y, xs( ps. w, 10 ), h, page.AlignCenter, "Shop" );
	page. drawText ( ps. x + xs( ps. w,  25 ), y, xs( ps. w, 85 ), h, page.AlignCenter, "Part" );
	page. drawText ( ps. x + xs( ps. w, 110 ), y, xs( ps. w, 10 ), h, page.AlignCenter, "Qty" );
	page. drawText ( ps. x + xs( ps. w, 120 ), y, xs( ps. w, 40 ), h, page.AlignLeft | page.AlignVCenter, "Category" );
	page. drawText ( ps. x + xs( ps. w, 150 ), y, xs( ps. w, 20 ), h, page.AlignCenter, "Item Type" );
