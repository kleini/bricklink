...
function listHeader ( page, ps )
{
    ...
    page. color = new Color ( "#ffffff" );
    page. drawText ( ps. x                   , y, xs( ps. w, 15 ), h, CReportPage.AlignCenter, "Image" );
    page. drawText ( ps. x + xs( ps. w,  15 ), y, xs( ps. w, 10 ), h, CReportPage.AlignCenter, "Shop" );
    page. drawText ( ps. x + xs( ps. w,  25 ), y, xs( ps. w, 85 ), h, CReportPage.AlignCenter, "Part" );
    page. drawText ( ps. x + xs( ps. w, 110 ), y, xs( ps. w, 10 ), h, CReportPage.AlignCenter, "Qty" );
    page. drawText ( ps. x + xs( ps. w, 120 ), y, xs( ps. w, 40 ), h, CReportPage.AlignLeft | CReportPage.AlignVCenter, "Category" );
    page. drawText ( ps. x + xs( ps. w, 150 ), y, xs( ps. w, 20 ), h, CReportPage.AlignCenter, "Item Type" );
...
function listItem ( page, ps, item, odd )
{
    ...
    page. drawText ( ps. x + xs( ps. w,  15 ), y, xs( ps. w, 10 ), h, CReportPage.AlignLeft    | CReportPage.AlignVCenter, item. status. include ? "Neu" : item. status. exclude ? "Vorh." : item. status. extra ? "Extra" : "???" );
    page. drawText ( ps. x + xs( ps. w,  25 ), y, xs( ps. w, 80 ), h, CReportPage.AlignLeft    | CReportPage.AlignVCenter | CReportPage.TextWordWrap, item. color. name + " " + item. name + " [" + item. id + "]" );
    page. drawText ( ps. x + xs( ps. w, 105 ), y, xs( ps. w,  5 ), h, CReportPage.AlignRight   | CReportPage.AlignVCenter, item. condition. used ? "U" : "N" );
    page. drawText ( ps. x + xs( ps. w, 110 ), y, xs( ps. w, 10 ), h, CReportPage.AlignHCenter | CReportPage.AlignVCenter, item. quantity );
    page. drawText ( ps. x + xs( ps. w, 120 ), y, xs( ps. w, 40 ), h, CReportPage.AlignLeft    | CReportPage.AlignVCenter, item. category. name );
    page. drawText ( ps. x + xs( ps. w, 150 ), y, xs( ps. w, 20 ), h, CReportPage.AlignRight   | CReportPage.AlignVCenter, item. itemType. name );
